export const dict = {
  ...
  "dialog.connectSync.title": "Connect \"{{workspace}}\" to sync",
  "dialog.connectSync.subtitle": "Files are encrypted on your machine before being sent to our servers — we never see their content.",
  "dialog.connectSync.step1.description": "Sign in to your Prisme account to choose a vault to sync this workspace with.",
  "dialog.connectSync.step1.cta": "Sign in with Prisme",
  "dialog.connectSync.step1.signingIn": "Signing in… check your browser",
  "dialog.connectSync.step2.description": "Choose a vault to sync this workspace to.",
  "dialog.connectSync.step2.signedInAs": "Signed in as {{email}}",
  "dialog.connectSync.step2.noVaults": "You don't have any vault yet. Create one on workspace.prisme.one.",
  "dialog.connectSync.step2.createNew": "Create a new vault on the website",
  ...
  "dialog.connectSync.step3.description": "Enter the encryption password for \"{{vault}}\".",
  "dialog.connectSync.step3.warning": "Without this password, your files cannot be decrypted — we can't recover it for you.",
  "dialog.connectSync.step3.passwordPlaceholder": "Vault encryption password",
  "dialog.connectSync.step3.cta": "Unlock & sync",
  "dialog.connectSync.connecting": "Connecting to the sync server…",
  "dialog.connectSync.done.title": "Synced",
  "dialog.connectSync.done.description": "Your workspace is now syncing.",
