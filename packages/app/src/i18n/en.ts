export const dict = {
  ...
  "command.review.toggle": "Toggle notes panel",
  ...
  "toast.update.description": "A new version of Prisme ({{version}}) is now available to install.",
  ...
  "session.panel.reviewAndFiles": "Notes and files",
  ...
  "notes.empty.description": "Choose a file from the explorer or create a Markdown note.",
  "notes.empty.create": "Create note",
  "notes.create.prompt": "Note name",
  "notes.create.defaultName": "Untitled note",
  "notes.create.defaultBody": "# {{name}}\n\n",
  "dialog.note.create.title": "Create note",
  "dialog.note.create.name.label": "Note name",
  "dialog.note.create.name.placeholder": "My ideas",
  "dialog.note.create.confirm": "Create",
  "dialog.note.create.error.exists": "A note with this name already exists.",
  "dialog.file.rename.title": "Rename file",
  "dialog.file.rename.name.label": "New name",
  "dialog.file.rename.confirm": "Rename",
  "dialog.file.rename.error.exists": "A file with this name already exists.",
  "dialog.file.delete.title": "Delete file",
  "dialog.file.delete.description": "Are you sure you want to delete \"{{name}}\"? This action cannot be undone.",
  "dialog.file.delete.confirm": "Delete",
  "dialog.file.create.title": "New file",
  "dialog.file.create.name.label": "File name",
  "dialog.file.create.name.placeholder": "example.md",
  "dialog.file.create.confirm": "Create",
  "dialog.file.create.error.exists": "A file with this name already exists.",
  "dialog.directory.create.title": "New folder",
  "dialog.directory.create.name.label": "Folder name",
  "dialog.directory.create.name.placeholder": "My folder",
  "dialog.directory.create.confirm": "Create",
  "dialog.directory.create.error.exists": "A folder with this name already exists.",
  "dialog.directory.create.defaultName": "New folder",
  "dialog.directory.rename.title": "Rename folder",
  "dialog.directory.delete.title": "Delete folder",
  "dialog.directory.delete.description": "Delete \"{{name}}\" and all its contents? This action cannot be undone.",
  "dialog.directory.delete.confirm": "Delete",
  "fileTree.action.rename": "Rename",
  "fileTree.action.delete": "Delete",
  "fileTree.action.newFile": "New file",
  "fileTree.action.newDirectory": "New folder",
  "fileTree.action.newSubDirectory": "New subfolder",
  "toast.file.rename.failed.title": "Failed to rename file",
  "toast.file.delete.failed.title": "Failed to delete file",
  "toast.file.create.failed.title": "Failed to create file",
  "toast.directory.create.failed.title": "Failed to create folder",
  "toast.directory.delete.failed.title": "Failed to delete folder",
  "toast.directory.rename.failed.title": "Failed to rename folder",
  ...
  "settings.general.row.language.description": "Change the display language for Prisme",
  ...
  "settings.general.row.appearance.description": "Customise how Prisme looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Prisme follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Prisme is themed.",
  "settings.general.voice.deepgramKey.title": "Deepgram API key",
  "settings.general.voice.deepgramKey.description": "Use Deepgram to transcribe prompt dictation.",
  "settings.general.voice.deepgramKey.placeholder": "Paste a Deepgram key",
  "settings.general.voice.language.title": "Voice language",
  "settings.general.voice.language.description": "Deepgram language code used for transcription.",
  "settings.general.voice.model.title": "Voice model",
  "settings.general.voice.model.description": "Deepgram model used for transcription.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Prisme launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Prisme.",
  "settings.general.section.support": "Share a bug",
  "settings.support.row.bugEmail.title": "By email",
  "settings.support.row.bugEmail.description": "Send a message to the Prisme team with your installation info.",
  "settings.support.row.bugEmail.action": "Compose email",
  "settings.support.row.bugIssue.title": "On GitHub",
  "settings.support.row.bugIssue.description": "Open a pre-filled GitHub form (GitHub account required).",
  "settings.support.row.bugIssue.action": "Open GitHub",
  "voice.action.start": "Start dictation",
  "voice.action.stop": "Stop dictation",
  "voice.state.recording": "Recording",
  "voice.error.missingKey.title": "Deepgram key required",
  "voice.error.missingKey.description": "Add your Deepgram API key in Settings to use voice input.",
  "voice.error.connection.title": "Voice connection failed",
  "voice.error.connection.description": "The Deepgram connection was interrupted.",
  "voice.error.microphone.title": "Microphone unavailable",
  "voice.error.microphone.description": "Prisme could not access your microphone.",
  ...
  // ─── Prisme Sync (E2EE vault sync) ───────────────────────────────────
  // common.loading / common.disconnect already defined above
  "common.back": "Back",
  "common.retry": "Retry",

  "header.sync.notSynced": "Connect to sync",
  "header.sync.signingIn": "Signing in…",
  "header.sync.unlockRequired": "Unlock to sync",
  "header.sync.connecting": "Connecting…",
  "header.sync.synced": "Synced",
  "header.sync.syncing": "Syncing…",
  "header.sync.error": "Sync error",
  "header.sync.disconnect": "Disconnect this workspace",

  "header.config.label": "Configuration",
  "header.config.title": "Platform configuration",
  "header.config.lastSync": "Last sync: {{date}}",
  "header.config.neverSynced": "Never synced",
  "header.config.computing": "Computing changes…",
  "header.config.upToDate": "Configuration up to date. No changes.",
  "header.config.pull": "{{count}} to download",
  "header.config.push": "{{count}} to upload",
  "header.config.conflicts": "{{count}} conflict(s)",
  "header.config.revoked": "{{count}} revoked",
  "header.config.conflict.local": "Local",
  "header.config.conflict.remote": "Remote",
  "header.config.conflict.readOnly": "Read-only — cannot upload",
  "header.config.deleteRevoked": "Delete revoked files",
  "header.config.apply": "Apply",
  "header.config.applying": "Applying…",
  "header.config.resolveFirst": "Resolve conflicts first",
  "header.config.report.pulled": "{{count}} downloaded",
  "header.config.report.pushed": "{{count}} uploaded",
  "header.config.report.revoked": "{{count}} deleted",
  "header.config.report.conflictsResolved": "{{count}} conflict(s) resolved",
  "header.config.report.rejected": "{{count}} rejected by the server",

  "dialog.connectSync.workspace": "Workspace · {{workspace}}",
  "dialog.connectSync.stepCount": "Step {{current}} of {{total}}",
  "dialog.connectSync.encryptionNote": "End-to-end encrypted on this device",
  "dialog.connectSync.cancel": "Cancel",

  "dialog.connectSync.step1.title": "Sign in",
  "dialog.connectSync.step1.subtitle": "Connect your Prisme account to access your vaults.",
  "dialog.connectSync.step1.cta": "Sign in with Prisme",
  "dialog.connectSync.step1.signingIn": "Signing in… check your browser",

  "dialog.connectSync.step2.title": "Choose a vault",
  "dialog.connectSync.step2.subtitle": "Pick the vault that will store this workspace.",
  "dialog.connectSync.step2.signedInAs": "{{email}}",
  "dialog.connectSync.step2.noVaults": "No vault available.",
  "dialog.connectSync.step2.noVaultsHint": "Create your first vault on workspace.prisme.one.",
  "dialog.connectSync.step2.createNew": "Create a vault",
  "dialog.connectSync.step2.ownerPersonal": "Personal",
  "dialog.connectSync.step2.ownerTeam": "Team",
  "dialog.connectSync.step2.ownerCompany": "Company",
  ...
  "dialog.connectSync.done.title": "Workspace synced",
  "dialog.connectSync.done.description": "Your files will be backed up encrypted to the Prisme cloud.",

  "dialog.connectSync.error.title": "Something went wrong",
  ...
  "settings.sync.account.notSignedIn": "You are not signed in.",
  "settings.sync.account.signIn": "Sign in with Prisme",
  "settings.sync.account.signOut": "Sign out",
  "settings.sync.account.signedInAs": "{{email}}",
  "settings.sync.account.plan": "{{plan}} plan",
  "settings.sync.account.plan.free": "Free",
  "settings.sync.account.plan.sync": "Sync",
  "settings.sync.account.plan.team": "Team",
  "settings.sync.preferences": "Preferences",
  "settings.sync.askOnOpen.title": "Ask to enable sync when opening a workspace",
  "settings.sync.askOnOpen.description": "Show the \"Connect to sync\" dialog automatically when you open a workspace that isn't synced yet.",
  "settings.sync.connected": "Connected workspaces",
  "settings.sync.connected.empty": "No workspace is connected to a vault. Open a workspace and click \"Connect to sync\" in the header.",
  "settings.sync.disconnect": "Disconnect",
  "settings.sync.vaults": "Vaults",
  "settings.sync.vaults.description": "Create and manage vaults from your account on the website.",
  "settings.sync.vaults.manage": "Manage vaults",
}
