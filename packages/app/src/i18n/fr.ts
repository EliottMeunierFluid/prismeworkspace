export const dict = {
  ...
  "command.review.toggle": "Basculer le panneau notes",
  ...
  "toast.update.description":
    "Une nouvelle version de Prisme ({{version}}) est maintenant disponible pour installation.",
  ...
  "session.panel.reviewAndFiles": "Notes et fichiers",
  ...
  "dialog.note.create.title": "Créer une note",
  "dialog.note.create.name.label": "Nom de la note",
  "dialog.note.create.name.placeholder": "Mes idées",
  "dialog.note.create.confirm": "Créer",
  "dialog.note.create.error.exists": "Une note portant ce nom existe déjà.",
  "dialog.file.rename.title": "Renommer le fichier",
  "dialog.file.rename.name.label": "Nouveau nom",
  "dialog.file.rename.confirm": "Renommer",
  "dialog.file.rename.error.exists": "Un fichier portant ce nom existe déjà.",
  "dialog.file.delete.title": "Supprimer le fichier",
  "dialog.file.delete.description": "Êtes-vous sûr de vouloir supprimer « {{name}} » ? Cette action est irréversible.",
  "dialog.file.delete.confirm": "Supprimer",
  "dialog.file.create.title": "Nouveau fichier",
  "dialog.file.create.name.label": "Nom du fichier",
  "dialog.file.create.name.placeholder": "exemple.md",
  "dialog.file.create.confirm": "Créer",
  "dialog.file.create.error.exists": "Un fichier portant ce nom existe déjà.",
  "dialog.directory.create.title": "Nouveau dossier",
  "dialog.directory.create.name.label": "Nom du dossier",
  "dialog.directory.create.name.placeholder": "Mon dossier",
  "dialog.directory.create.confirm": "Créer",
  "dialog.directory.create.error.exists": "Un dossier portant ce nom existe déjà.",
  "dialog.directory.create.defaultName": "Nouveau dossier",
  "dialog.directory.rename.title": "Renommer le dossier",
  "dialog.directory.delete.title": "Supprimer le dossier",
  "dialog.directory.delete.description": "Supprimer « {{name}} » et tout son contenu ? Cette action est irréversible.",
  "dialog.directory.delete.confirm": "Supprimer",
  "fileTree.action.rename": "Renommer",
  "fileTree.action.delete": "Supprimer",
  "fileTree.action.newFile": "Nouveau fichier",
  "fileTree.action.newDirectory": "Nouveau dossier",
  "fileTree.action.newSubDirectory": "Nouveau sous-dossier",
  "toast.file.rename.failed.title": "Échec du renommage",
  "toast.file.delete.failed.title": "Échec de la suppression",
  "toast.file.create.failed.title": "Échec de la création",
  "toast.directory.create.failed.title": "Échec de la création du dossier",
  "toast.directory.delete.failed.title": "Échec de la suppression du dossier",
  "toast.directory.rename.failed.title": "Échec du renommage du dossier",
  ...
  "app.name.desktop": "Prisme Desktop",
  ...
  "settings.general.section.voice": "Voix",
  "settings.general.row.language.title": "Langue",
  "settings.general.row.language.description": "Changer la langue d'affichage pour Prisme",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence de Prisme sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Prisme suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème de Prisme.",
  "settings.general.voice.deepgramKey.title": "Clé API Deepgram",
  "settings.general.voice.deepgramKey.description": "Utilise Deepgram pour transcrire la dictée dans le prompt.",
  "settings.general.voice.deepgramKey.placeholder": "Collez une clé Deepgram",
  "settings.general.voice.language.title": "Langue vocale",
  "settings.general.voice.language.description": "Code langue Deepgram utilisé pour la transcription.",
  "settings.general.voice.model.title": "Modèle vocal",
  "settings.general.voice.model.description": "Modèle Deepgram utilisé pour la transcription.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement de Prisme",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version de Prisme.",
  "settings.general.section.support": "Partager un bug",
  "settings.support.row.bugEmail.title": "Par email",
  "settings.support.row.bugEmail.description": "Envoyer un message à l'équipe Prisme avec les informations de votre installation.",
  "settings.support.row.bugEmail.action": "Écrire un email",
  "settings.support.row.bugIssue.title": "Sur GitHub",
  "settings.support.row.bugIssue.description": "Ouvrir un formulaire GitHub pré-rempli (compte GitHub requis).",
  "settings.support.row.bugIssue.action": "Ouvrir GitHub",
  "voice.action.start": "Démarrer la dictée",
  "voice.action.stop": "Arrêter la dictée",
  "voice.state.recording": "Enregistrement",
  "voice.error.missingKey.title": "Clé Deepgram requise",
  "voice.error.missingKey.description": "Ajoutez votre clé API Deepgram dans les paramètres pour utiliser la voix.",
  "voice.error.connection.title": "Connexion vocale échouée",
  "voice.error.connection.description": "La connexion Deepgram a été interrompue.",
  "voice.error.microphone.title": "Micro indisponible",
  "voice.error.microphone.description": "Prisme n'a pas pu accéder au micro.",
  ...
  // ─── Prisme Sync (vault E2EE) ────────────────────────────────────────
  // common.loading / common.disconnect déjà définis plus haut
  "common.back": "Retour",
  ...
  "header.sync.error": "Erreur sync",
  "header.sync.disconnect": "Désynchroniser ce workspace",

  "header.config.label": "Configuration",
  "header.config.title": "Configuration plateforme",
  "header.config.lastSync": "Dernière synchro : {{date}}",
  "header.config.neverSynced": "Jamais synchronisé",
  "header.config.computing": "Calcul des changements…",
  "header.config.upToDate": "Configuration à jour. Aucun changement.",
  "header.config.pull": "{{count}} à télécharger",
  "header.config.push": "{{count}} à envoyer",
  "header.config.conflicts": "{{count}} conflit(s)",
  "header.config.revoked": "{{count}} révoqué(s)",
  "header.config.conflict.local": "Local",
  "header.config.conflict.remote": "Distant",
  "header.config.conflict.readOnly": "Lecture seule — non envoyable",
  "header.config.deleteRevoked": "Supprimer les fichiers révoqués",
  "header.config.apply": "Appliquer",
  "header.config.applying": "Application…",
  "header.config.resolveFirst": "Résoudre les conflits d'abord",
  "header.config.report.pulled": "{{count}} téléchargé(s)",
  "header.config.report.pushed": "{{count}} envoyé(s)",
  "header.config.report.revoked": "{{count}} supprimé(s)",
  "header.config.report.conflictsResolved": "{{count}} conflit(s) résolu(s)",
  "header.config.report.rejected": "{{count}} rejeté(s) par le serveur",

  "dialog.connectSync.workspace": "Workspace · {{workspace}}",
  "dialog.connectSync.stepCount": "Étape {{current}} sur {{total}}",
  "dialog.connectSync.encryptionNote": "Chiffrement de bout en bout sur cet appareil",
  "dialog.connectSync.cancel": "Annuler",

  "dialog.connectSync.step1.title": "Se connecter",
  "dialog.connectSync.step1.subtitle": "Connecte ton compte Prisme pour accéder à tes vaults.",
  "dialog.connectSync.step1.cta": "Se connecter avec Prisme",
  "dialog.connectSync.step1.signingIn": "Connexion… vérifie ton navigateur",

  "dialog.connectSync.step2.title": "Choisir un vault",
  "dialog.connectSync.step2.subtitle": "Sélectionne le coffre où synchroniser ce workspace.",
  "dialog.connectSync.step2.signedInAs": "{{email}}",
  "dialog.connectSync.step2.noVaults": "Aucun vault disponible.",
  "dialog.connectSync.step2.noVaultsHint": "Crée ton premier vault depuis workspace.prisme.one.",
  "dialog.connectSync.step2.createNew": "Créer un vault",
  "dialog.connectSync.step2.ownerPersonal": "Personnel",
  "dialog.connectSync.step2.ownerTeam": "Équipe",
  "dialog.connectSync.step2.ownerCompany": "Entreprise",
  ...
  "dialog.connectSync.done.title": "Workspace synchronisé",
  "dialog.connectSync.done.description": "Tes fichiers seront sauvegardés chiffrés sur le cloud Prisme.",

  "dialog.connectSync.error.title": "Une erreur est survenue",
  ...
  "settings.sync.account.notSignedIn": "Vous n'êtes pas connecté.",
  "settings.sync.account.signIn": "Se connecter avec Prisme",
  "settings.sync.account.signOut": "Se déconnecter",
  "settings.sync.account.signedInAs": "{{email}}",
  "settings.sync.account.plan": "Plan {{plan}}",
  "settings.sync.account.plan.free": "Gratuit",
  "settings.sync.account.plan.sync": "Sync",
  "settings.sync.account.plan.team": "Équipe",
  "settings.sync.preferences": "Préférences",
  "settings.sync.askOnOpen.title": "Proposer d'activer la sync à l'ouverture d'un workspace",
  "settings.sync.askOnOpen.description": "Affiche automatiquement la fenêtre « Activer la sync » quand vous ouvrez un workspace qui n'est pas encore synchronisé.",
  "settings.sync.connected": "Workspaces connectés",
  "settings.sync.connected.empty": "Aucun workspace n'est connecté à un vault. Ouvrez un workspace et cliquez sur « Activer la sync » dans l'en-tête.",
  "settings.sync.disconnect": "Déconnecter",
  "settings.sync.vaults": "Vaults",
  "settings.sync.vaults.description": "Créez et gérez vos vaults depuis votre compte sur le site.",
  "settings.sync.vaults.manage": "Gérer les vaults",
}
