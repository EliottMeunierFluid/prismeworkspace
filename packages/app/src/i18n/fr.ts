export const dict = {
  ...
  "dialog.connectSync.title": "Connecter « {{workspace}} » à la sync",
  "dialog.connectSync.subtitle": "Les fichiers sont chiffrés sur votre machine avant d'être envoyés à nos serveurs — nous ne voyons jamais leur contenu.",
  "dialog.connectSync.step1.description": "Connectez-vous à votre compte Prisme pour choisir un vault à synchroniser avec ce workspace.",
  "dialog.connectSync.step1.cta": "Se connecter avec Prisme",
  "dialog.connectSync.step1.signingIn": "Connexion… vérifiez votre navigateur",
  "dialog.connectSync.step2.description": "Choisissez un vault pour synchroniser ce workspace.",
  "dialog.connectSync.step2.signedInAs": "Connecté en tant que {{email}}",
  "dialog.connectSync.step2.noVaults": "Vous n'avez pas encore de vault. Créez-en un sur workspace.prisme.one.",
  "dialog.connectSync.step2.createNew": "Créer un nouveau vault sur le site",
  ...
  "dialog.connectSync.step3.description": "Saisissez le mot de passe de chiffrement de « {{vault}} ».",
  "dialog.connectSync.step3.warning": "Sans ce mot de passe, vos fichiers ne pourront pas être déchiffrés — nous ne pouvons pas le récupérer pour vous.",
  "dialog.connectSync.step3.passwordPlaceholder": "Mot de passe de chiffrement du vault",
  "dialog.connectSync.step3.cta": "Déverrouiller et synchroniser",
  "dialog.connectSync.connecting": "Connexion au serveur de sync…",
  "dialog.connectSync.done.title": "Synchronisé",
  "dialog.connectSync.done.description": "Votre workspace est maintenant synchronisé.",
  "dialog.connectSync.error.signIn": "Échec de la connexion. Veuillez réessayer.",
  ...
  "dialog.connectSync.error.saltMissing": "Métadonnées du vault manquantes. Rafraîchissez et réessayez.",
